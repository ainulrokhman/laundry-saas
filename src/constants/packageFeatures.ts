...
export const PACKAGE_DEFINITIONS: Record<string, PackageDefinition> = {
    KUCEK: {
        ...
        slug: 'kucek',
        price: 0,
        description: 'Mulai usaha laundry tanpa biaya, fitur dasar cukup untuk operasional harian.',
        features: [
    ...
    BERSIH: {
        ...
        slug: 'bersih',
        price: 49000,
        description: 'Fitur lebih bersih tanpa iklan di nota, manajemen stok dasar, dan laporan lebih detail.',
        features: [
            PackageFeature.BASIC_POS,
            PackageFeature.ORDER_MANAGEMENT,
    ...
    WANGI: {
        ...
        slug: 'wangi',
        price: 99000,
        description: 'Fitur notifikasi otomatis dan keamanan log anti-maling membuat bisnis lebih wangi.',
        features: [
            PackageFeature.BASIC_POS,
            PackageFeature.ORDER_MANAGEMENT,
    ...
    LICIN: {
        ...
        slug: 'licin',
        price: 149000,
        description: 'Solusi manajemen lengkap untuk multi-outlet dan pertumbuhan bisnis tanpa hambatan.',
        features: [
            PackageFeature.BASIC_POS,
            PackageFeature.ORDER_MANAGEMENT,
            PackageFeature.INVOICE_CUSTOM,
