...
export default function TransactionsPage() {
  ...
  const fetchStats = async () => {
    try {
      ...
      const res = await fetch(
        `/api/dashboard/transactions/stats?${params.toString()}`,
      );
  ...
  const handleExport = async () => {
    try {
      ...
      const res = await fetch(
        `/api/dashboard/transactions/export?${params.toString()}`,
      );
                    ...
                    {transactions.map((transaction) => (
                      <tr key={transaction.id}>
                        ...
                        <td>
                          ...
                          >
                            {transaction.type === TransType.SUBSCRIPTION
                              ? "Subscription"
                              : "Laundry"}
                          </span>
                        </td>
              ...
              <div className="modal-body">
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <p className="mb-0">
                      <span
                        className={`badge ${getTypeBadge(selectedTransaction.type)}`}
                      >
                  ...
                  <div className="col-md-6">
                    ...
                    <p className="mb-0">
                      <span
                        className={`badge ${getStatusBadge(selectedTransaction.status)}`}
                      >
                  ...
                  {selectedTransaction.settledAt && (
                    <div className="col-md-6">
                      ...
                      <p className="mb-0">
                        {formatDateTime(selectedTransaction.settledAt)}
                      </p>
                    </div>
                  )}
