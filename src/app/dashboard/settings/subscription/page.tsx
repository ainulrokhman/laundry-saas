        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-md-6">
              <div
                className={`card ${
                  isExpired ? "card-danger" : "card-primary"
                } card-outline`}
              >
                  ...
                  <ul className="list-group list-group-unbordered mb-3">
                    ...
                    <li className="list-group-item">
                      ...
                      <span className="float-end">
                        {formatCurrency(data?.price || 0)} / bulan
                      </span>
                    </li>
                    <li className="list-group-item">
                      <b>Berlaku Sampai</b>{" "}
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="text-muted">
                    Anda menggunakan <b>{data?.usedOutlets}</b> dari{" "}
                    <b>{max}</b> slot outlet.
                  </p>
                  <div className="progress mb-3" style={{ height: "20px" }}>
                    <div
                      className={`progress-bar ${
                        !isUnlimited && progress >= 100
                          ? "bg-danger"
                          : "bg-primary"
                      }`}
                  ...
                  {!isUnlimited && (
                    <div className="alert alert-info mt-4">
                      ...
                      Ingin menambah cabang lebih banyak? Upgrade ke paket{" "}
                      <b>Pro</b> atau <b>Enterprise</b> untuk kebutuhan skala
                      besar.
                    </div>
                  )}
                </div>
